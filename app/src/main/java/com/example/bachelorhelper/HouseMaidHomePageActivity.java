...
public class HouseMaidHomePageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_house_maid_home_page);

        customAddress = findViewById(R.id.customAddressInputMaidHomePage);
        addButton = findViewById(R.id.maidHomePageAddButton);

        //get id from the xml
        sp_parent = (Spinner) findViewById(R.id.sp_parent_maidHomePage);
        sp_child = (Spinner) findViewById(R.id.sp_child_maidHomePage);
    ...
    private void addDataToDatabase() {
        ...
        map = new HashMap<>();
        String serviceLocation = customAddress.getText().toString();

        map.put("Service Location", serviceLocation);
        map.put("City", city);
        map.put("Area", area);
        ...
        FirebaseDatabase.getInstance().getReference("User").child(ownerID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                map.put("Maid Phone Number", phone);
                String maidAddress = snapshot.child("Maid Address").getValue(String.class);
                map.put("Maid Address", maidAddress);
                String maidEmail = snapshot.child("Email").getValue(String.class);
                map.put("Maid Email", maidEmail);
                String maidNID = snapshot.child("NID").getValue(String.class);
                map.put("Maid NID", maidNID);
    ...
    private void openAptOwnerHomePageActivity() {
        Intent intent = new Intent(HouseMaidHomePageActivity.this, aptOwnerHomePageActivity.class);
